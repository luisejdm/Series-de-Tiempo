...
fma::plastics |> 
  autoplot()
```
Como se aprecia en la gráfica, tiene una tendencia alcista. Así mismo, presenta estacionalidad anual con picos a la alza alrededor del octavo mes y luego caidas bruscas hasta el año nuevo.
